...
public final class MatrixServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.AddRequest,
      com.example.grpc.server.grpcserver.AddReply> METHOD_ADD_BLOCK =
      io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.AddRequest, com.example.grpc.server.grpcserver.AddReply>newBuilder()
          ...
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.AddReply.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.MultiplyRequest,
      com.example.grpc.server.grpcserver.MultiplyReply> METHOD_MULTIPLY_BLOCK =
      io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.MultiplyRequest, com.example.grpc.server.grpcserver.MultiplyReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
          ...
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.MultiplyReply.getDefaultInstance()))
          .build();
  ...
  public static abstract class MatrixServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addBlock(com.example.grpc.server.grpcserver.AddRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.server.grpcserver.AddReply> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_ADD_BLOCK, responseObserver);
    }

    /**
     */
    public void multiplyBlock(com.example.grpc.server.grpcserver.MultiplyRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.server.grpcserver.MultiplyReply> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.example.grpc.server.grpcserver.AddReply>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.example.grpc.server.grpcserver.MultiplyReply>(
  ...
  public static final class MatrixServiceBlockingStub extends io.grpc.stub.AbstractStub<MatrixServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.AddReply addBlock(com.example.grpc.server.grpcserver.AddRequest request) {
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.MultiplyReply multiplyBlock(com.example.grpc.server.grpcserver.MultiplyRequest request) {
      return blockingUnaryCall(
  ...
  public static final class MatrixServiceFutureStub extends io.grpc.stub.AbstractStub<MatrixServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.server.grpcserver.AddReply> addBlock(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.server.grpcserver.MultiplyReply> multiplyBlock(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_BLOCK:
          serviceImpl.addBlock((com.example.grpc.server.grpcserver.AddRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.server.grpcserver.AddReply>) responseObserver);
          break;
        case METHODID_MULTIPLY_BLOCK:
          serviceImpl.multiplyBlock((com.example.grpc.server.grpcserver.MultiplyRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.server.grpcserver.MultiplyReply>) responseObserver);
          break;
        default:
